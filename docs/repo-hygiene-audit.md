...
- reviewed root layout for core folders (`cmd/`, `internal/`, `docs/`, `skills/`, `levelups/`)
- reviewed naming consistency around `visor`, `levelup`, and `visor-admin`
...
- naming is consistent with current command/runtime vocabulary (`levelup`, `visor-admin`)
