...
id: TASK-54
title: >-
  M9 | Iteration 2: reliability + observability | Add per-subagent run IDs and
  structured logs (start/end/duration/error)
status: To Do
assignee: []
...
Original item: Add per-subagent run IDs and structured logs (start/end/duration/error)
