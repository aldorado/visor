...
id: TASK-28
title: >-
  M12 | Research tasks | Investigate how CLAUDE.md / .pi/instructions can detect
  first-run state (no `.env`, no `data/` dir, no running process)
status: To Do
assignee: []
...
Original item: Investigate how CLAUDE.md / .pi/instructions can detect first-run state (no `.env`, no `data/` dir, no running process)
