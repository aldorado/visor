...
id: TASK-55
title: >-
  M9 | Iteration 2: reliability + observability | Add partial-failure strategy
  (continue with surviving agents, mark degraded mode)
status: To Do
assignee: []
...
Original item: Add partial-failure strategy (continue with surviving agents, mark degraded mode)
