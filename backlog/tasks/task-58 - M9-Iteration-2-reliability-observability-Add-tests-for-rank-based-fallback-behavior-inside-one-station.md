...
id: TASK-58
title: >-
  M9 | Iteration 2: reliability + observability | Add tests for rank-based
  fallback behavior inside one station
status: To Do
assignee: []
...
Original item: Add tests for rank-based fallback behavior inside one station
