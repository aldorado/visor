...
id: TASK-63
title: >-
  M9 | Iteration 3: automatic orchestration | Add fallback to single-agent mode
...
Original item: Add fallback to single-agent mode when orchestration is unnecessary
